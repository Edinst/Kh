...
module.exports = {
  config: {
    ...
    guide: {
      en: "To add a file to a specific directory, use the command: `addfile <directory/no> <file/folder> <name> <content/no>`"
    }
  },
  langs: {
    en: {
  ...
  onStart: async function ({ api, event, args, message }) {
    try {
      if (args.length < 4) {
        throw new Error("Invalid arguments. Usage: `.addfile2 <directory name/no> | <folder/file> | <name folder/file> | <content file/no>`");
      }
